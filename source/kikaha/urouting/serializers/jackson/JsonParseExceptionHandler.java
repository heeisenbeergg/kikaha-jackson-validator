...
public class JsonParseExceptionHandler implements ExceptionHandler<JsonProcessingException> {

	@Override
	public Response handle(final JsonProcessingException cause) {
		return DefaultResponse.ok("BAD REQUEST: " + cause.getMessage()).statusCode(400);
	}
}
